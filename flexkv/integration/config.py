...
class FlexKVConfig:
    ...
    def post_init_from_vllm_config(
        ...
        # Detect the packed layout before the NVFP4 fold below: this leaves
        # head_size at 2 * head_size, and nvfp4_kv_cache_full_dim is linear, so
        # folding afterwards packs both halves.
